...
search_url = 'http://www.boattrader.com/search-results/NewOrUsed-any/Type-all/Category-all/Zip-77552/Radius-400/Sort-Length:DESC'
item_links = []
page_number = 1
count = 1
link_count = 0
...
import csv
with open('Output_File_New_Gulfcoast.csv', 'w') as fp:
