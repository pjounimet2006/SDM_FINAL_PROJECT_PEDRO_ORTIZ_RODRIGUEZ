...
search_url = 'http://www.boattrader.com/search-results/NewOrUsed-any/Type-all/Category-all/Zip-10020/Radius-400/Sort-Length:DESC'
item_links = []
page_number = 1
count = 1
link_count = 0
...
import csv
with open('Output_File_New_NorthEast.csv', 'w') as fp:
