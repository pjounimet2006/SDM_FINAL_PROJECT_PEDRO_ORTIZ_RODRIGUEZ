...
search_url = 'http://www.boattrader.com/search-results/NewOrUsed-any/Type-all/Category-all/Zip-90009/Radius-400/Sort-Length:DESC'
item_links = []
page_number = 1
count = 1
link_count = 0
...
import csv
with open('Output_File_Pacific.csv', 'w') as fp:
